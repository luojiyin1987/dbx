...
test("Windows compatibility jobs cache Rust compilation without wrapping C or C++", () => {
  ...
  for (const setting of ["RUSTC_WRAPPER: sccache", 'SCCACHE_GHA_ENABLED: "true"', "SCCACHE_GHA_VERSION: win7-webview2-1.0.902.49-v1", 'SCCACHE_IDLE_TIMEOUT: "0"', 'CARGO_PROFILE_RELEASE_LTO: "off"', 'CARGO_PROFILE_RELEASE_CODEGEN_UNITS: "8"', 'CARGO_PROFILE_RELEASE_OPT_LEVEL: "1"']) assert.ok(win7.includes(setting));
